...
public:
    ...
    {
        AdrenalineNodeConfigDialog->setWindowTitle(QApplication::translate("AdrenalineNodeConfigDialog", "PhantomX Node Configuration Template", nullptr));
#ifndef QT_NO_TOOLTIP
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example phantomx.conf template with the necessary masternode settings.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
